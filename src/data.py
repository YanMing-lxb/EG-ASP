...
# 数据来源：Dow Chemical USA. 2001b. Engineering manual for DOWTHERM SR-1and DOWTHERM 4000 inhibited ethylene glycol heat transfer fluids.Midland, MI.
# 乙二醇水溶液的密度 (kg/m3) (数据来源ASHRAE手册2005)
eg_rho = [
...
# 乙二醇水溶液的比热 (J/kg.K) (数据来源ASHRAE手册2005)
eg_cp = [
...
# 乙二醇水溶液导热系数 (W/m.K) (数据来源ASHRAE手册2005)
eg_k = [
...
# 乙二醇水溶液动力粘度 (kg/m·s) (数据来源ASHRAE手册2005)
eg_mu = [
